  ...
  render() {
    return (
      <div>
        ...
        <Draggable><img src="/image1.jpg" className={styles.image} style={{ left: 'calc(9vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image2.jpg" className={styles.image} style={{ left: 'calc(18vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image3.jpg" className={styles.image} style={{ left: 'calc(27vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image4.jpg" className={styles.image} style={{ left: 'calc(36vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image5.jpg" className={styles.image} style={{ left: 'calc(45vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image6.jpg" className={styles.image} style={{ left: 'calc(54vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image7.jpg" className={styles.image} style={{ left: 'calc(63vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image8.jpg" className={styles.image} style={{ left: 'calc(72vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image9.jpg" className={styles.image} style={{ left: 'calc(81vw*0.9)' }} draggable="false" /></Draggable>
        <Draggable><img src="/image10.jpg" className={styles.image} style={{ left: 'calc(90vw*0.9)' }} draggable="false" /></Draggable>
